...
public class TestSuit extends TopMenuTest {
    ...
    public void verifyProductAddedToShoppingCartSuccessFully() throws InterruptedException {
        ...
        mouseHoverToElement(By.xpath("//div[@class='picture']/descendant::img[@alt='Picture of Build your own computer']"));
        mouseHoverToElement(By.xpath("//div[@class='buttons']/child::button\""));

        //2.5 Verify the Text "Build your own computer"
        verifyText("Build your own computer", By.linkText("Build your own computer"), getTextOnElement(By.linkText("Build your own computer")));
        ...
        verifyText("$1,430.00", By.xpath("//span[@id='price-value-1']"), getTextOnElement(By.xpath("//span[@id='price-value-1']")));
        //2.12 Click on "ADD TO CARD" Button
        clickOnElement(By.xpath("//button[@id='add-to-cart-button-1']"));

        verifyText("The product has been added to your shopping cart", By.xpath("//p[@class='content']"),
                getTextOnElement(By.xpath("//p[@class='content']")));
        ...
        verifyText("Shopping cart", By.xpath("//h1[contains(text(),'Shopping cart')]"),
                getTextOnElement(By.xpath("//h1[contains(text(),'Shopping cart')]")));
        //2.16 Change the Qty to "2" and Click on "Update shopping cart"
        Thread.sleep(5000);
        WebElement quantity = driver.findElement(By.xpath("//td[@class='quantity']/child::input"));
        quantity.clear();
        quantity.sendKeys("2");
        mouseHoverToElement(By.xpath("//tbody/tr[1]/td[4]"));
        mouseHoverToElement(By.xpath("//button[@id='updatecart']"));
        //2.17 Verify the Total"$2,950.00"
        verifyText("$2,860.00", By.xpath("//tr[@class='order-total']/child::td//following::td/child::span"),
                getTextOnElement(By.xpath("//tr[@class='order-total']/child::td//following::td/child::span")));
        //2.18 click on checkbox “I agree with the terms of service”
        clickOnElement(By.xpath("//input[@id='termsofservice']"));

        //2.19 Click on “CHECKOUT”
        mouseHoverToElement(By.xpath("//div[@class='checkout-buttons']"));
        mouseHoverToElement(By.xpath("//button[@id='checkout']"));

        //2.20 Verify the Text “Welcome, Please Sign In!”
        verifyText("Welcome, Please Sign In!", By.xpath("//h1[contains(text(),'Welcome, Please Sign In!')]"),
                getTextOnElement(By.xpath("//h1[contains(text(),'Welcome, Please Sign In!')]")));
        //2.21 Click on “CHECKOUT AS GUEST” Tab
        clickOnElement(By.xpath("//strong[contains(text(),'Checkout as a guest or register')]"));
        //2.22 Fill the all mandatory field
        mouseHoverToElement(By.xpath("//body/div[6]/div[3]/div[1]/div[1]/div[1]/div[2]/div[1]/div[1]/div[3]"));
        mouseHoverToElement(By.xpath("//button[contains(text(),'Checkout as Guest')]"));
        //2.22 Fill the all mandatory field
        sendTextToElement(By.xpath("//input[@id='BillingNewAddress_FirstName']"), "Nehal");
        ...
        selectByVisibleTextFromDropDown(By.xpath("//select[@id='BillingNewAddress_StateProvinceId']"), "gujrat");
        sendTextToElement(By.xpath("//input[@id='BillingNewAddress_City']"), "vyaa");
        ...
        sendTextToElement(By.xpath("//input[@id='BillingNewAddress_PhoneNumber']"), "hhh");
        sendTextToElement(By.xpath("//input[@id='BillingNewAddress_City']"), "jkjjh");
        ...
        verifyText("Next Day Air", By.xpath("//span[contains(text(),'Next Day Air')]"), getTextOnElement(By.xpath("//span[contains(text(),'Next Day Air')]")));
        //2.33 Verify Total is “$2,950.00”
        verifyText("$2,860.00", By.xpath("//span[@class='value-summary']/child::strong"), getTextOnElement(By.xpath("//span[@class=\"value-summary\"]/child::strong")));
        ...
        verifyText("Welcome to our store", By.xpath("//h2[contains(text(),'Welcome to our store')]"), getTextOnElement(By.xpath("//h2[contains(text(),'Welcome to our store')]")));
    }
}
